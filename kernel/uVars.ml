...
module LevelInstance : sig
    ...
    val pr : (Quality.QVar.t -> Pp.t) -> (Level.t -> Pp.t) -> ?variances:Variances.t -> t -> Pp.t
...
struct
  ...
  let union (names, (univs, csts)) (names', (univs', csts')) =
    append_bound_names names names', (LevelInstance.append univs univs', PolyConstraints.union csts csts')
