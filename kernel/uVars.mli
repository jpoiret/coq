...
val enforce_eq_variance_instances : nargs:application -> Variances.t -> Instance.t poly_constraint_function
val enforce_leq_variance_instances : nargs:application -> Variances.t -> Instance.t poly_constraint_function
...
sig
  ...
  val of_context_set : (LevelInstance.t -> bound_names) -> Quality.QVar.Set.t -> ContextSet.t -> t
